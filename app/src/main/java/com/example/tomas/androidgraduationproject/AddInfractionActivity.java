...
public class AddInfractionActivity extends AppCompatActivity {
    ...
    public void buAddTool(View view) {
        ...
        if(Name.getText().toString() !="" && Description.getText().toString() !="" &&Street.getText().toString() !="" && City.getText().toString() !="" && Cost.getText().toString() !="" && Number.getText().toString() !="" && CID.getText().toString() !="")
        {
            ...
            String url = SaveSettings.ServerURL +"UsersWS.asmx/AddInfraction?Name="+ Name.getText().toString()+"&Des="+ Description.getText().toString()+"&Street="+Street.getText().toString()+"&City="+City.getText().toString()+"&Cost="+Cost.getText().toString()+"&Number="+Number.getText().toString()+"&CID="+Integer.parseInt(CID.getText().toString());
